...
<strong dir="rtl">اگر از گیت استفاده می‌کنید، می‌توانید این پروژه را fork یا clone کنید و یک remote به آدرس همین پروژه اضافه کنید. در غیر این صورت، محتویات پروژه را دانلود کرده و بسته‌ی `base` را دانلود و `import` کنید.</strong>
